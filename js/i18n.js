...
(function () {
    ...
    var translations = {
        ...
        es: {
            ...
            'nav.make_payment': 'Hacer un Pago',
            'nav.community_docs': 'Documentos',

            // Mobile
            'mobile.call_us': 'Llamar',
            'mobile.swipe_hint': 'Deslice para ver m\u00e1s',
            ...
            'hero.desc': 'Administraci\u00f3n completa de asociaciones HOA y condominios con m\u00e1s de 20 a\u00f1os de experiencia dedicados a proteger y darle valor a su inversi\u00f3n inmobiliaria.',
            'hero.cta_proposal': 'Pedir una Propuesta',
            ...
            'trust.emergency': 'Atenci\u00f3n de Emergencia',

            // About
            'about.label': 'Sobre ASPMG',
            'about.title': 'Administraci\u00f3n Dedicada<br>en Miami y Broward',
            'about.lead': 'ASPMG le brinda una administraci\u00f3n profesional y econ\u00f3mica, siempre con sus metas como prioridad.',
            'about.desc': 'Nuestro equipo se encarga de desarrollar planes estrat\u00e9gicos para mejorar las \u00e1reas comunes, resolver reparaciones de manera efectiva, bajar costos y planificar proyectos importantes \u2014 todo mientras nos hacemos cargo de las operaciones del d\u00eda a d\u00eda sin ning\u00fan contratiempo.',
            'about.feat1_title': 'Comunicaci\u00f3n Transparente',
            'about.feat1_desc': 'Le mantenemos al tanto con actualizaciones constantes para que siempre sepa lo que est\u00e1 pasando con su propiedad.',
            'about.feat2_title': 'Servicio Personalizado',
            'about.feat2_desc': 'Para nosotros usted no es "uno m\u00e1s." Le brindamos soluciones de administraci\u00f3n hechas a su medida.',
            'about.feat3_title': 'Emergencias 24/7',
            'about.feat3_desc': 'Contamos con servicio las 24 horas para atender cualquier emergencia que se presente.',
            'about.badge_text': 'A\u00f1os de<br>Excelencia',

            // Services
            'services.label': 'Nuestros Servicios',
            'services.title': 'Soluciones Completas de<br>Administraci\u00f3n de Propiedades',
            'services.subtitle': 'Una administraci\u00f3n completa, hecha a la medida de las necesidades de su comunidad',
            'services.financial_title': 'Gesti\u00f3n Financiera',
            'services.financial_desc': 'Conciliaci\u00f3n anual de CAM, cuentas por cobrar y por pagar, estados de cuenta mensuales, auditor\u00edas, preparaci\u00f3n de presupuesto e informes financieros.',
            'services.maintenance_title': 'Mantenimiento',
            'services.maintenance_desc': 'Planes de mantenimiento a la medida, supervisi\u00f3n de contratistas, gesti\u00f3n de cotizaciones, avisos de reparaci\u00f3n y servicio de emergencia las 24 horas a su disposici\u00f3n.',
            'services.property_title': 'Administraci\u00f3n de Propiedades',
            'services.property_desc': 'Planes estrat\u00e9gicos para mantener el valor de su propiedad a largo plazo: reuniones, elecciones, presupuestos, seguridad, violaciones, parqueo y operaciones diarias.',
            'services.tech_title': 'Tecnolog\u00eda',
            'services.tech_desc': 'Cuentas en l\u00ednea, portales de pago, formularios electr\u00f3nicos, creaci\u00f3n de p\u00e1ginas web y comunicaciones digitales para una administraci\u00f3n moderna y eficiente.',
            'services.comms_title': 'Comunicaciones',
            'services.comms_desc': 'Cuentas privadas con actualizaciones sobre inspecciones, informes financieros, avisos, mantenimiento y proyectos. Le mantenemos informado en todo momento.',
            'services.inspect_title': 'Inspecciones',
            'services.inspect_desc': 'Recorridos regulares de la propiedad con documentaci\u00f3n detallada. Planes de mantenimiento preventivo que nos han permitido lograr ahorros importantes y bajar los costos de seguro.',
            'services.learn_more': 'Conozca M\u00e1s',

            // Differentiators
            'diff.label': 'Por Qu\u00e9 Elegirnos',
            'diff.title': 'Cuidamos Su Comunidad<br>Como Si Fuera Nuestra',
            'diff.1_title': 'Experiencia Local',
            'diff.1_desc': 'Conocemos a fondo las regulaciones, los contratistas y las necesidades de Miami-Dade y Broward.',
            'diff.2_title': 'Ahorro en Costos',
            'diff.2_desc': 'Planificaci\u00f3n financiera estrat\u00e9gica que ha eliminado la necesidad de cuotas especiales en nuestras comunidades.',
            'diff.3_title': 'Inspecciones Preventivas',
            'diff.3_desc': 'Recorridos regulares y mantenimiento preventivo que logran ahorros importantes en reparaciones costosas.',
            'diff.4_title': 'A la Vanguardia Tecnol\u00f3gica',
            ...
            'testimonial.1': '"ASPMG nos ha brindado un servicio de primera durante tres a\u00f1os. Han administrado varias de mis unidades. En mi experiencia en bienes ra\u00edces trabajo con m\u00e1s de 10 asociaciones al a\u00f1o y pocas son tan atentas y cumplidas como ellos. Los recomiendo con toda confianza."',
            'testimonial.1_role': 'Miembro de Junta Directiva',
            'testimonial.2': '"Es una compa\u00f1\u00eda de administraci\u00f3n muy seria y confiable. Se dedican de verdad a resolver los problemas de nuestra asociaci\u00f3n con soluciones inteligentes. Gracias a ellos, las finanzas de nuestra comunidad mejoraron un 200%. Los recomiendo a cualquiera que quiera una comunidad tranquila y bien administrada."',
            'testimonial.2_role': 'Miembro de Junta Directiva',
            'testimonial.3': '"\u00a1Esta empresa de administraci\u00f3n es lo m\u00e1ximo! En este mundo de condominios hacen falta personas que de verdad se preocupen y est\u00e9n dispuestas a dar la milla extra. Recorren la propiedad pr\u00e1cticamente a diario, se quedan hasta tarde resolviendo situaciones y siempre tienen sugerencias que mejoran nuestra comunidad. \u00a1Su honestidad no tiene comparaci\u00f3n!"',
            'testimonial.3_role': 'Miembro de Junta Directiva',
            'testimonial.4': '"A Solid Property Management lleva trabajando con nuestra asociaci\u00f3n 4 a\u00f1os y medio y la experiencia ha sido excelente. No nos han subido los costos de mantenimiento, arreglamos el techo, sacamos la recertificaci\u00f3n de 40 a\u00f1os y repintamos toda la comunidad \u2014 todo sin cobros especiales."',
            'testimonial.4_role': 'Residente',

            // FAQ
            'faq.label': 'Preguntas Frecuentes',
            'faq.title': 'Preguntas Frecuentes',
            'faq.q1': '\u00bfQu\u00e9 servicios brinda ASPMG?',
            'faq.a1': 'ASPMG brinda administraci\u00f3n completa de propiedades que incluye gesti\u00f3n financiera, coordinaci\u00f3n de mantenimiento, inspecciones, soluciones tecnol\u00f3gicas y atenci\u00f3n de emergencia 24/7 para asociaciones HOA y condominios en Miami-Dade y Broward.',
            'faq.q2': '\u00bfC\u00f3mo puedo hacer un pago para mi comunidad?',
            'faq.a2': 'Puede hacer pagos seguros por internet a trav\u00e9s de nuestro <a href="payments.html">portal de pagos</a>. Solo tiene que buscar el nombre de su comunidad y hacer clic para ir a nuestro procesador seguro, DirectBiller.',
            'faq.q3': '\u00bfQu\u00e9 \u00e1reas atiende ASPMG?',
            'faq.a3': 'Atendemos comunidades en todo Miami-Dade y Broward, Florida. Nuestro conocimiento local nos permite brindarle una administraci\u00f3n cercana y atenta, con dominio de las regulaciones de la zona y los mejores contratistas.',
            'faq.q4': '\u00bfC\u00f3mo puedo reportar un problema de mantenimiento?',
            'faq.a4': 'Puede reportar cualquier situaci\u00f3n de mantenimiento llam\u00e1ndonos al <a href="tel:3056618400">(305) 661-8400</a> o escribi\u00e9ndonos a <a href="mailto:info@aspmg.com">info@aspmg.com</a>. Para emergencias, nuestra l\u00ednea 24/7 est\u00e1 siempre a su disposici\u00f3n.',
            'faq.q5': '\u00bfC\u00f3mo aplico para alquilar o comprar en una comunidad administrada?',
            'faq.a5': 'Entre a nuestra p\u00e1gina de <a href="documents.html">Documentos</a> para bajar la aplicaci\u00f3n de su comunidad. Las aplicaciones completas se pueden entregar en nuestra oficina junto con los documentos requeridos.',
            'faq.q6': '\u00bfQu\u00e9 hace diferente a ASPMG de las compa\u00f1\u00edas grandes de administraci\u00f3n?',
            'faq.a6': 'En ASPMG usted nunca es "uno m\u00e1s." Le brindamos un servicio personalizado y cercano con acceso directo a su equipo de administraci\u00f3n. Nuestro enfoque dedicado garantiza que su comunidad reciba la atenci\u00f3n que se merece, con el respaldo de m\u00e1s de 20 a\u00f1os de experiencia local.',

            // CTA
            'cta.title': '\u00bfSu Comunidad Se Pierde Dentro<br>de una Empresa Administradora Gigante?',
            'cta.desc': 'En ASPMG usted nunca es "uno m\u00e1s." D\u00e9jenos mostrarle lo que es una administraci\u00f3n de verdad personalizada y dedicada.',
            'cta.btn': 'Pedir Consulta Sin Costo',

            // Contact
            'contact.label': 'Cont\u00e1ctenos',
            'contact.title': '\u00bfListo Para Mejorar la Administraci\u00f3n<br>de Su Comunidad?',
            ...
            'contact.form_community': 'Nombre de la Comunidad',
            'contact.form_subject': 'Asunto *',
            'contact.form_subject_default': 'Escoja un tema...',
            'contact.form_subject_1': 'Pedir Propuesta de Administraci\u00f3n',
            'contact.form_subject_2': 'Reporte de Mantenimiento',
            'contact.form_subject_3': 'Pregunta de Facturaci\u00f3n',
            ...
            // Footer
            'footer.desc': 'Administraci\u00f3n completa de asociaciones HOA y condominios al servicio de Miami-Dade y Broward por m\u00e1s de 20 a\u00f1os.',
